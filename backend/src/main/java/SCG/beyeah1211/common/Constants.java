...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "./storage/upload/";//上传文件目录（相对 backend 工作目录）
    public final static String FILE_GOODS_IMG_DIC = "./storage/goods-img/";//商品图片目录（相对 backend 工作目录）
    ...
    public final static String MALL_USER_SESSION_KEY = "beyeahUser";//session中user的key
