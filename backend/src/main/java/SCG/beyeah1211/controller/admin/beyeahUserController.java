...
public class beyeahUserController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(beyeahUserService.getbeyeahUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (beyeahUserService.lockUsers(ids, lockStatus)) {
